...
export function FaqContent({ usageKey }: { usageKey: string }) {
  ...
  if (isLoading) {
    return (
      <div className="rounded-3xl border-2 border-primary/10 bg-[#F4F9FF] dark:bg-slate-900/50 p-8 shadow-sm">
  ...
  return (
    <div className="rounded-3xl border-2 border-primary/10 bg-[#F4F9FF] dark:bg-slate-900/50 px-6 py-7 md:px-10 md:py-7 shadow-sm relative overflow-hidden">
