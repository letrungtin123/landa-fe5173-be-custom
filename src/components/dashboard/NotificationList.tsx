      ...
      <div className="space-y-6">
        {mockNotifications.map((notification, index) => {
          ...
          return (
            ...
            >
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#EBF3FC]">
                <Icon className="h-[20px] w-[20px] text-[#1877F2] stroke-[2]" />
              </div>
              <div className="flex-1 min-w-0 pt-0.5">
                ...
                <p className="mt-1.5 text-[11px] font-medium text-[#A3A3A3]">
                  {notification.time}
                </p>
              </div>
            </motion.div>
